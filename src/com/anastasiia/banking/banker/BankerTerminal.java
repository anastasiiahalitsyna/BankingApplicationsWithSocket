package com.anastasiia.banking.banker;
    ...
    private static void listenCommandLineAndSendToSocketServer(Socket clientSocket,
        ...
        while (true) {
            try {
                ...
                if (commandLineInput.startsWith("MODIFY_CUSTOMER")
                        || commandLineInput.startsWith("ADD_CUSTOMER")) {
                    System.out.printf("%s Sending following command: %s %s", currentDate, commandLineInput, System.lineSeparator());
                ...
                System.out.printf("%s Response: %s %s", currentDate, socketResponse, System.lineSeparator());
